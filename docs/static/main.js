...
var $author$project$Main$Model = function (dependencies) {
...
var $author$project$Main$init = function (flag) {
	return _Utils_Tuple2(
		$author$project$Main$Model(flag.V),
...
var $author$project$Deps$headerView = _List_fromArray(
	[
		A2(
		$elm$html$Html$th,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('text-left p-2')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text('Repository')
			])),
		A2(
		$elm$html$Html$th,
		_List_fromArray(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Stackage Snapshot')
			]))
	]);
...
var $author$project$Deps$view = F2(
	function (idx, deps) {
		return A2(
			$elm$html$Html$tr,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('border-top'),
					$elm$html$Html$Attributes$class(
					(!A2($elm$core$Basics$modBy, 2, idx)) ? 'bg-gray-light' : '')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('text-left p-3')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('link-gray-dark'),
									$elm$html$Html$Attributes$href('https://github.com/' + deps.H)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(deps.H)
								]))
						])),
					A2(
					$elm$html$Html$td,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('text-center p-3')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('link-gray-dark'),
									$elm$html$Html$Attributes$href('https://www.stackage.org/' + deps.J)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(deps.J)
								]))
						]))
				]));
	});
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Deps Sensor')
										]))
								]))
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('col-12 f2 break-word'),
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('border-bottum')
												]),
											$author$project$Deps$headerView)
										])),
									A2(
									$elm$html$Html$tbody,
									_List_Nil,
									A2($elm$core$List$indexedMap, $author$project$Deps$view, model.P))
								]))
						]))
				]))
		]);
...
var $author$project$Main$view = function (model) {
	return {
		aq: $author$project$Main$bodyView(model),
		aE: 'Deps Sensor'
	};
};
				...
				A2(
					...
					function (snapshot) {
						return A2(
							...
							function (repository) {
								return $elm$json$Json$Decode$succeed(
									{H: repository, J: snapshot});
							},
							A2($elm$json$Json$Decode$field, 'repository', $elm$json$Json$Decode$string));
					},
					A2($elm$json$Json$Decode$field, 'snapshot', $elm$json$Json$Decode$string))))))(0)}});}(this));